...
// Platform: clock, ids, password hashing, JWT. Small and boring on purpose.
...
// PHP's password_verify handles the $2a$ / $2y$ bcrypt variants transparently.
...
// Short-lived access JWTs plus opaque, rotating refresh tokens stored in Redis.
// Rotating a refresh token revokes it, so a stolen-and-replayed token fails.
