...
// snake_case fields, RFC3339 timestamps. Explicit shaping keeps the domain (camelCase)
// separate from the wire.

import { Event, Order, QueueToken, Reservation, Sector } from '../domain/models';
import { EventDetail, TokenPair } from '../usecase/services';
...
export const eventDetailDto = (d: EventDetail) => ({ ...eventDto(d.event), sectors: d.sectors.map(sectorDto) });
