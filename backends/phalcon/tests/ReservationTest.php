...
// Unit tests for the reservation use case. No database, no Phalcon. Sequential (PHP is
// single-threaded); they pin exhaustion, idempotency, release, and sweep logic. The
// concurrency/overselling proof for this backend is the load test.
