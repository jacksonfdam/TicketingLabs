// Domain errors: a stable machine code and a safe, public message. Never a stack trace
// or a SQL string. The transport layer maps the code to an HTTP status and wraps the
// message in the standard envelope. Codes match the Go and FastAPI backends exactly.
